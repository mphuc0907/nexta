<?php
/* Template Name: Xác nhận thanh toán */
get_header();
...
<main class="main">
    <section class="sectiom-top cart-section step-4">
        <div class="container">
            <div class="proce">
                <div class="title">
            ...
            <div class="list-pro">
                <div class="row payment">
                    <div class="col-xl-7 col-md-12">
                        <form action="" id="Formhome" class="needs-validation form" novalidate>
                            ...
                            <div class="box-form form-two ">
                                ...
                                <div class="info-form">
                                    <div class="list-info">
                                        ...
                                        <div class="list-info-item d-none">
                                            <p>Thành phố:</p>
                                            <span id="citys"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-check-op">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-md-12 col-12 input-laber">
                                                ...
                                                <input type="text" name="city" value="Việt Nam" class="form-control"
                                ...
                                <div class="form-check">
                                    ...
                                    <div class="content-bank" style="display: none">
                                        <div class="info-bank">
                                            ...
                                            <div class="info-bank-item">
                                                <span>Nội dung</span>
                                                <p id="inf">Thanh toan don hang <span
                                                            id="code2">NEX<?= $number ?></span></p>
                                            </div>
                                        </div>
                                        <div class="qr">
                                            <img src="<?= get_template_directory_uri() ?>/dist/images/859f8fc72cc228b9a999ca7fc588d804.png"
                                                 alt="">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="policy">
                                <div class="form-check-policy d-flex">
                                    <input class="form-check input-policy" type="checkbox" value=""
                                           id="flexCheckDefault"
                                           required checked>
                                    <label class="form-check label-policy" for="flexCheckDefault"
                                           style="padding-left: 0.25rem;">
                                        Tôi đồng ý với <a href="<?= get_field('url_policy', 'option') ?>"
                                                          target="_blank">
                            ...
                            <div class="gotype">
                                <a class="repla" href="<?= home_url() ?>/chi-tiet-thanh-toan/">Quay lại</a>
                                <button class="btn btn-ucss" type="submit">Hoàn tất đặt hàng</button>
                            </div>
...
<script>
    $(document).ready(function () {
        ...
        // var number = Math.floor(Math.random() * 66666);
        // $('#code').text(number);
        // $('#code2').text(number);
...
<script !src="">
    ...
    var usser = localStorage.getItem("usser");
    var buyNow = localStorage.getItem("buyNow");
    var voucher = localStorage.getItem("voucher");
    $(document).ready(function ($) {
        let dataUser = [];
        dataUser = usser ? JSON.parse(usser) : [];
        $('#names').text(dataUser.surname + " " + dataUser.name);
        $('#phones').text(dataUser.phone);
        $('#emails').text(dataUser.email);
        $('#locations').text(dataUser.address);
        $('#citys').text(dataUser.city);
        $('input[name="name"]').val(dataUser.name);
        $('input[name="surname"]').val(dataUser.surname);
        $('input[name="phone"]').val(dataUser.phone);
        $('input[name="email"]').val(dataUser.email);
        $('input[name="address"]').val(dataUser.address);
        $('input[name="city"]').val(dataUser.city);
    });
