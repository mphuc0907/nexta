...
function rocket_check_key() {
	...
	$rocket_options                   = [];
	$rocket_options['consumer_key']   = '45a396f4-5187-4d57-8787-47a0106f80fc';
	$rocket_options['consumer_email'] = 'noreply@gmail.com';
	$rocket_options['secret_key'] = 'zorerkekallreadyhere';
