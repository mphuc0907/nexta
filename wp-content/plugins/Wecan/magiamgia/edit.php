...
$myrows = $wpdb->get_row( "SELECT * FROM voucher WHERE id=".$id );
                    ...
                    <div class="postbox">
                        ...
                        <div class="inside">
                            ...
                            <table class="form-table ft_metabox leftform">
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="validate-input" id="ten_chuong_trinh"
                                               name="ten_chuong_trinh" value="<?= $myrows->voucher_name ?>" size="50" placeholder="Nhập vào">
                                        <label id="ten_chuong_trinh-error" class="error d-none" for="ten_chuong_trinh">
                                            Không được để trống ô</label>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="validate-input" id="ma_voucher" name="ma_voucher"
                                               value="<?= $myrows->voucher_code ?>" size="50" placeholder="Nhập vào" readonly>
                                        ...
                                        <div class="loaigiamgia">
                                            <div class="type-gg">
                                                <select name="" id="loai_giam_gia">
                                                    <option <?= $myrows->discount_type == 1?'selected':'' ?> value="1">Theo số tiền</option>
                                                    <option <?= $myrows->discount_type == 2?'selected':'' ?> value="2">Theo phần trăm</option>
                                                </select>
                                            </div>
                                            <div class="price-gg">
                                                <div class="type-input type-1">
                                                    <input type="number" class="" id="muc_giam" value="<?= $myrows->discount_amount ?>"
                                                           placeholder="Nhập vào">
                                                    <label id="muc_giam-error" class="error d-none" for="muc_giam">Không
                                                        được để trống ô</label>
                                                </div>
                                                <div class="type-input type-2 d-none">
                                                    <input type="number" class="" id="muc_giam_2" value="<?= $myrows->discount_amount ?>"
                                    ...
                                    <td>
                                        <div class="">
                                            <input type="number" class="inputnumber validate-input"
                                                   id="gia_tri_toi_thieu" value="<?= $myrows->gia_tri_toi_thieu ?>" placeholder="Nhập vào">
                                ...
                                <tr>
                                    <td>
                                        Số lượng <span class="red-validate">*</span>
                                    </td>
                                    <td>
                                        <div class="">
                                            <input type="number" class="inputnumber validate-input"
                                                   id="so_luong" value="<?= $myrows->number_of_vouchers ?>" placeholder="Nhập vào">
                                            <label id="so_luong-error" class="error d-none"
                                                   for="so_luong">Không được để trống ô</label>
                                        </div>
                                    </td>
                                </tr>
                            </table>
    ...
    <div class="modal-address">
        <div class="popup__content">
            ...
            <div style="margin-bottom: 20px; margin-top: 20px;" class="special-member-container">
                <input type="checkbox" name="specialMember" id="specialMember" <?php if($myrows->voucher_for_special_member == 1) { echo 'checked'; } ?>>
