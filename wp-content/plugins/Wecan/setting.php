...
//    add_submenu_page( 'daily_list', 'Thêm mới Tài Khoản', 'Thêm mới Tài Khoản','manage_options', 'adddaily','adddaily');
    ...
    add_menu_page( 'Đơn hàng ứng dụng', 'Đơn hàng ứng dụng', 'manage_options', 'application_manager', 'application' , 'dashicons-nametag', 40);
...
function dondat(){
    include plugin_dir_path( __FILE__ ) . '/orders_tour/order.php';
}
