...
<head>
	...
	<link rel="stylesheet" type="text/css" href="dist/assets/phuc.css">
	<link rel="stylesheet" type="text/css" href="dist/assets/quyenanh.css">
</head>
<header class="header">
		...
		<div class="header-desktop">
			<div class="container">
				<div class="header-inner">
					<div class="logo"><a href="http://nexta.wecan-group.info/html/">
					...
					<div class="menu-right">
						<div class="mega-menu">
							<ul>
								...
								<li>
									<div class="links">
										<a href="http://nexta.wecan-group.info/html/device-smart.php">Sản phẩm</a>
									</div>	
								</li>
								<li>
									<div class="links">
										<a href="http://nexta.wecan-group.info/html/smartclass.php">Lớp học thông minh</a>
									</div>
								</li>
								<li>
									<div class="links">
		...
		<div class="header-mobile">
			<div class="mobile-bar">
				<div class="mobile-logo">
					<a href="#">
						<figure><img src="dist/images/logo.png" alt="logo"></figure>
					</a>
				</div>
				<div class="bar-right">
				...
				<div class="menu-inner">
					...
					<div class="menu-middle">
						<ul>
							...
							<li>
                                <a href="#">Tin tức & Sự kiện<i class="fas fa-caret-down"></i></a>
                                <ul>
                                    <li>
                                        <a href="#">Level 2<i class="fas fa-caret-down"></i></a>
                                        <ul>
							...
							<li>
                                <a href="#">Hỗ trợ khách hàng 247<i class="fas fa-caret-down"></i></a>
                                <ul>
                                    <li>
                                        <a href="#">Level 2<i class="fas fa-caret-down"></i></a>
                                        <ul>
